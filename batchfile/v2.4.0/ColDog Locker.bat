...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFDhbQCCNO1eKD7YI/fr+/NakrUE5W+V/S5vO3r2BM9w/5ULrO58u2Ro=
...
::ZQ05rAF9IAHYFVzEqQITJxdwQwPCEGS5DbAOqN/y4e6ItV59
::eg0/rx1wNQPfEVWB+kM9LVsJDCeNME+1AfUw5+vw6vjn
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDhbQCCNO1eeCbYJ5e31+/m7gUIRcO04OKPU2b+LMtwk40vgeoE+lllVltgDAB5kaEDlOkFklU1NukCKMIewvAzqT1rH41M1ew==
::YB416Ek+ZG8=
::
::
...
if NOT EXIST "%USERPROFILE%\AppData\Roaming\ColDogStudios\exp.cfg" > "%USERPROFILE%\AppData\Roaming\ColDogStudios\exp.cfg" echo 0
attrib +H +S "%USERPROFILE%\AppData\Roaming\ColDogStudios\exp.cfg"
for /F "delims=" %%x in ("%USERPROFILE%\AppData\Roaming\ColDogStudios\exp.cfg") do set /A stars=%%x
set /A stars=10
if "%stars%"=="0"  set "advbar=-                                                -"
if "%stars%"=="1"  set "advbar=-                       *                        -"
if "%stars%"=="2"  set "advbar=-                      * *                       -"
if "%stars%"=="3"  set "advbar=-                     * * *                      -"
if "%stars%"=="4"  set "advbar=-                    * * * *                     -"
if "%stars%"=="5"  set "advbar=-                   * * * * *                    -"
if "%stars%"=="6"  set "advbar=-                  * * * * * *                   -"
if "%stars%"=="7"  set "advbar=-                 * * * * * * *                  -"
if "%stars%"=="8"  set "advbar=-                * * * * * * * *                 -"
if "%stars%"=="9"  set "advbar=-               * * * * * * * * *                -"
if "%stars%"=="10" set "advbar=-              * * * * * * * * * *               -"
...
> "%USERPROFILE%\AppData\Roaming\ColDogStudios\exp.cfg" echo 1
goto END
::***********************LIGHT************************
